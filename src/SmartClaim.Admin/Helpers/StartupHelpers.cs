...
using SmartClaim.Admin.ExceptionHandling;
using SmartClaim.Admin.Configuration;
using SmartClaim.Admin.Configuration.ApplicationParts;
using SmartClaim.Admin.Configuration.Constants;
using SmartClaim.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using SmartClaim.Admin.Helpers.Localization;
using System.Linq;
using SmartClaim.Admin.EntityFramework.MySql.Extensions;
using SmartClaim.Admin.EntityFramework.Shared.Configuration;
using SmartClaim.Admin.EntityFramework.SqlServer.Extensions;
using SmartClaim.Admin.EntityFramework.PostgreSQL.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using SmartClaim.Shared.Authentication;
using SmartClaim.Shared.Configuration.Identity;

namespace SmartClaim.Admin.Helpers
{
