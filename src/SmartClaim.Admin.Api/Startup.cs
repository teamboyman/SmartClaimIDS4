...
using SmartClaim.Admin.Api.Configuration.Authorization;
using SmartClaim.Admin.Api.ExceptionHandling;
using SmartClaim.Admin.Api.Helpers;
using SmartClaim.Admin.Api.Mappers;
using SmartClaim.Admin.Api.Resources;
using SmartClaim.Admin.EntityFramework.Shared.DbContexts;
using SmartClaim.Admin.EntityFramework.Shared.Entities.Identity;
using SmartClaim.Shared.Dtos;
using SmartClaim.Shared.Dtos.Identity;
using SmartClaim.Shared.Helpers;

namespace SmartClaim.Admin.Api
{
