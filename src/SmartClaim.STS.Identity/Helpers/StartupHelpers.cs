...
using SendGrid;
using SmartClaim.Shared.Configuration.Email;
using SmartClaim.Shared.Email;
using SmartClaim.STS.Identity.Configuration;
using SmartClaim.STS.Identity.Configuration.ApplicationParts;
using SmartClaim.STS.Identity.Configuration.Constants;
...
namespace SmartClaim.STS.Identity.Helpers
{
